 ...
 * @SNAPD_ERROR_APP_NOT_FOUND: FIXME
 * @SNAPD_ERROR_ARCHITECTURE_NOT_AVAILABLE: FIXME
 * @SNAPD_ERROR_CHANGE_CONFLICT: FIXME
 * @SNAPD_ERROR_NOT_A_SNAP: FIXME
 * @SNAPD_ERROR_INTERFACES_UNCHANGED: FIXME
 * @SNAPD_ERROR_OPTION_NOT_FOUND: FIXME
 *
